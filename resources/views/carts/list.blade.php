...
@section('content')
        <!-- Shoping Cart -->
	<form class="bg0 p-t-150 p-b-100" method="post" >
	@include('admin.alert')
        @if(count($products) != 0)
		<div class="container">
			<div class="row">
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
                        ...
                        @endphp
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="p-r-15" style="">
										<a href="/carts/delete/{{$product->id}}"><i class=" zmdi zmdi-delete" style="font-size:166px"></i></a>
									</td>
                                @endforeach
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							<div class="flex-w flex-m m-r-20 m-tb-5">
								<form  formaction="/check-coupon" method="POST"></form>
									@csrf
									...
									<input type="submit" class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5" name="check_coupon" value="Tinh ma giam" >
								</form>
							</div>
